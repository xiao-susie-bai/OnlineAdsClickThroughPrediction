...
TrOutDF.to_csv('TrYHatFromBCNN4x10_100k.csv',sep=',',na_rep="NA",header=True,index=False)
ValOutDF.to_csv('ValYHatFromBCNN4x10_100k.csv',sep=',',na_rep="NA",header=True,index=False)
