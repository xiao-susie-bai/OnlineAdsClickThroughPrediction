...
BCNN.add(Dense(units=10,input_shape=(XTr.shape[1],),activation="relu",use_bias=True))
BCNN.add(Dense(units=10,activation="relu",use_bias=True))
BCNN.add(Dense(units=10,activation="relu",use_bias=True))
BCNN.add(Dense(units=10,activation="relu",use_bias=True))
...
TrOutDF.to_csv('TrYHatFromBCNN10x4_100k.csv',sep=',',na_rep="NA",header=True,index=False)
ValOutDF.to_csv('ValYHatFromBCNN10x4_100k.csv',sep=',',na_rep="NA",header=True,index=False)
